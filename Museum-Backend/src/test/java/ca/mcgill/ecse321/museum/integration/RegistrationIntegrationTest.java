...
public class RegistrationIntegrationTest {
	...
	public void testEmployeeRegister() {
		...
		employeeName.put("name", FIRST_VALID_EMPLOYEE_NAME);
		HttpHeaders headers = new HttpHeaders();
		headers.set("Cookie", manager.getSessionId());
		HttpEntity<Map<String, String>> entity = new HttpEntity<>(employeeName, headers);
	...
	public void testEmployeeRegisterWithInvalidName() {
		...
		Map<String, String> employeeName = new HashMap<>();
		employeeName.put("name", INVALID_EMPLOYEE_NAME);
		HttpHeaders headers = new HttpHeaders();
		headers.set("Cookie", manager.getSessionId());
		HttpEntity<Map<String, String>> entity = new HttpEntity<>(employeeName, headers);
	...
	public void testRegisterEmployeeWithoutLogin() {
		Map<String, String> employeeName = new HashMap<>();
		employeeName.put("name", FIRST_VALID_EMPLOYEE_NAME);
		HttpEntity<Map<String, String>> entity = new HttpEntity<>(employeeName);
	...
	public void testEditEmployee() {
		...
		ResponseEntity<EmployeeDto> response =
				client.exchange("/api/profile/employee/edit/" + employee.getMuseumUserId(), HttpMethod.PUT,
